#ifndef MAINOPENGLOFFSCREENSURFACE_H
#define MAINOPENGLOFFSCREENSURFACE_H
...
class MainOpenGLOffscreenSurface : public QOffscreenSurface
{
    Q_OBJECT
...
public:
    ...
    /// surface.
    explicit MainOpenGLOffscreenSurface(
        QScreen *targetScreen = nullptr,
        const QSize &size = QSize(1, 1));

    /// @brief Destructor.
    virtual ~MainOpenGLOffscreenSurface();
...
private:
    Q_DISABLE_COPY(MainOpenGLOffscreenSurface)
...
#endif // MAINOPENGLOFFSCREENSURFACE_H
